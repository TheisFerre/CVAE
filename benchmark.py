...
def benchmark(cluster_directory):
	...
	print('Bin name', 'DNA in bin', 'number of contigs', sep='\t', file=log_file)
	for bin_name in binning.bin_precision:
		print(bin_name, binning.bin_precision[bin_name]['length'], binning.bin_precision[bin_name]['contigs'], sep='\t', file=log_file)
